...
In order to run the system tests in Kubernetes &amp; Istio you need to apply the `coffee-shop/deployment/systemtest` Kubernetes resources: `kubectl apply -f coffee-shop/deployment/systemtest/`. The files assume that you have Istio installed on your cluster.
